      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <h1
              className="font-display text-4xl md:text-6xl font-bold text-foreground mb-6 animate-fade-in"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-6 bg-card rounded-xl border border-border hover:border-primary/50 transition-all hover-lift">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Reflections on building products, failed experiments, and the journey of continuous
                learning.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 border-t border-border">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            <h2 className="font-display text-2xl font-semibold text-foreground">Recent Posts</h2>
            <Link
              href="/blog"
